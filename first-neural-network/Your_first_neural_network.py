...
class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        for X, y in zip(features, targets):
            ...
            # signals into hidden layer 1x3 ~ 3x2 => 1x2 
            hidden_inputs = np.dot(X, self.weights_input_to_hidden) 
            # signals from hidden layer 1x2
            hidden_outputs = self.activation_function(hidden_inputs) 

            # TODO: Output layer - Replace these values with your calculations.
            # signals into final output layer 1x2 ~ 2x1 => 1x1
            final_inputs = np.dot(hidden_outputs, self.weights_hidden_to_output) 
            # signals from final output layer 1x1
            ...
            # Output layer error is the difference between desired target and actual output. 1x1
